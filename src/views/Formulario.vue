<template>
   <div class="container mt-2">
     <b-form>
       ...
       <b-form-group label="Código do Produto" label-for="codigo_subject">
         <b-form-input id="codigo_subject"
         v-model="form.codigo_subject"
         type="text"
         placeholder="Ex: Item - 132562"
         required
         autocomplete="off" >
         </b-form-input>
       </b-form-group>
       ...
       <b-form-group label="Descrição do Produto" label-for="description">
